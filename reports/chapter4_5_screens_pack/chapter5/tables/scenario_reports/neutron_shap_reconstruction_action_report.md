# Scenario action report: neutron_shap_reconstruction

- module: `Bonner SHAP reconstruction`
- adapter_called: `False`
- output_type: `registered metadata only`
- status: `planned`
- evidence_level: `planned`
- action: `not_run`
- claim_scope: registered future adapter, excluded from quantitative claims
