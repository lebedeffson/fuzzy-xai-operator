...
| `trust_ade` | `fixture-certified` | `repository-output-level` | trust assessment / risk observer extension | trust-assessment report route and observer compatibility |
| `synt_isic_timeshap` | `fixture-certified` | `repository-output-level` | synthetic dermatology / temporal SHAP / causal validation | temporal explanation route and report generation, not local dermatology validation |
| `eaar_regularization` | `planned` | `planned` | attribution regularization / feature importance consistency | registered future adapter, excluded from quantitative claims |
| `neutron_shap_reconstruction` | `planned` | `planned` | physical inverse problem / neutron spectra / SHAP regularization | registered future adapter, excluded from quantitative claims |