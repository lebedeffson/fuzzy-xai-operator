...
- `context` = `{"experiment_id": "digits_logistic_clean", "task_type": "image_like_classification", "perturbation": "clean", "representation_class": "F_ML", "prediction_interval_width": 0.0, "conflict_component": 0.0, "noise_ratio": 0.0, "occlusion_rate": 0.0}`

## Formula
class_id выбирается по task_type, interval, source/quality conflict и multilevel context

## Components
- `input_conditions` = `["image_like_classification", "clean"]`
- `interval_width` = `0.0`
- `quality_penalty` = `0.0`
