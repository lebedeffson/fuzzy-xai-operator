...
- `context` = `{"experiment_id": "digits_mlp_pixel_noise", "task_type": "image_like_classification", "perturbation": "noise", "representation_class": "F_ML", "prediction_interval_width": 0.0, "conflict_component": 0.0, "noise_ratio": 0.0, "occlusion_rate": 0.42}`

## Formula
class_id выбирается по task_type, interval, source/quality conflict и multilevel context

## Components
- `input_conditions` = `["image_like_classification", "noise"]`
- `interval_width` = `0.0`
