...
- `context` = `{"experiment_id": "diabetes_gbr_wide_interval", "task_type": "tabular_regression", "perturbation": "wide_interval", "representation_class": "F_int", "prediction_interval_width": 0.48, "conflict_component": 0.0, "noise_ratio": 0.0, "occlusion_rate": 0.0}`
