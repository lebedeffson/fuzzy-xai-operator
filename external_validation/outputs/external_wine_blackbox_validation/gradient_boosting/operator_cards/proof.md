...
## Input
- `computed_result` = `{"class_probability": 0.679119, "uncertainty": 0.320881, "quality_penalty": 0.0, "gamma": 0.320881, "delta": 0.429844, "rho": 0.429844, "diagnostic_id": "D_external_tabular_uncertainty", "action_id": "lower_confidence", "action": "lower_confidence"}`
