...
def main() -> int:
    ...
    for model_key in MODEL_KEYS:
        required.extend(
            [
                ...
                PACKAGE_DIR / model_key / "operator_trace.json",
                PACKAGE_DIR / model_key / "operator_table.csv",
                PACKAGE_DIR / model_key / "proof_trace.json",
                PACKAGE_DIR / model_key / "verifier_report.json",
                PACKAGE_DIR / model_key / "dashboard_data.json",
                PACKAGE_DIR / model_key / "operator_dashboard.png",
                PACKAGE_DIR / model_key / "operator_dashboard_v2.png",
                PACKAGE_DIR / model_key / "operator_dashboard_v2.html",
    ...
    expected_zip_entries = {
        ...
        "external_wine_blackbox_validation/logistic_regression/operator_trace.json",
        "external_wine_blackbox_validation/logistic_regression/operator_table.csv",
        "external_wine_blackbox_validation/logistic_regression/proof_trace.json",
        "external_wine_blackbox_validation/logistic_regression/verifier_report.json",
        "external_wine_blackbox_validation/logistic_regression/dashboard_data.json",
        ...
        "external_wine_blackbox_validation/logistic_regression/operator_dashboard_v2.png",
        "external_wine_blackbox_validation/logistic_regression/operator_dashboard_v2.html",
        "external_wine_blackbox_validation/gradient_boosting/route.json",
        "external_wine_blackbox_validation/gradient_boosting/operator_trace.json",
        "external_wine_blackbox_validation/gradient_boosting/operator_table.csv",
        "external_wine_blackbox_validation/gradient_boosting/proof_trace.json",
        "external_wine_blackbox_validation/gradient_boosting/verifier_report.json",
        "external_wine_blackbox_validation/gradient_boosting/dashboard_data.json",
        ...
        "external_wine_blackbox_validation/gradient_boosting/operator_dashboard_v2.png",
        "external_wine_blackbox_validation/gradient_boosting/operator_dashboard_v2.html",
    }
