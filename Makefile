...
.PHONY: ch4-q1-test h10-c5-source-audit h10-c5-run h10-c5b-test h10-c5b-ops-test h10-c5b-prepare h10-c5b-prepare-runtime-inputs h10-c5b-collect-runtime h10-c5b-merge-runtime h10-c5b-runtime-readiness h10-c5b-freeze-development h10-c5b-freeze-held-out-scoring h10-c5b-plan-replacements h10-c5b-run h10-c5b-score-held-out h10-c5b-verify-method-lock h10-c5b-parent-immutability h10-c5c-test h10-c5c-posthoc h10-c5c-posthoc-detailed h10-c5c-posthoc-oracles h10-c5c-prepare-bugsinpy h10-c5c-collect-runtime h10-c5c-development-readiness h10-c5c-run-development h10-c7-test h10-c7-build-open-replay h10-c7-open-replay h10-c7-confirmation h10-c7-r5v-audit h10-c7-prepare-development h10-c7-run-development h10-c5-pilot-test h10-c5-pilot-run h10-c6-run h10-c6-n-test h10-c6-n-prepare h10-c6-n-run mlflow-integration-test mlflow-integration-run final-practical-parent-immutability final-practical-package multimodal-route-validation h9-e2e-latency h9-e2e-v2 ch4-q1-claim-lint ch4-q1-evidence
...
h10-c7-test:
	$(H10_C4_ENV) $(H10_C3_PYTHON) -m ruff check framework/fuzzyxai/fuzzyxai/repository_diagnostics/guided_retrieval.py framework/fuzzyxai/fuzzyxai/repository_diagnostics/guided_diagnosis.py framework/fuzzyxai/fuzzyxai/repository_diagnostics/contract_inference_v2.py framework/fuzzyxai/fuzzyxai/repository_diagnostics/active_evidence.py framework/fuzzyxai/fuzzyxai/repository_diagnostics/incident_router.py framework/fuzzyxai/fuzzyxai/repository_diagnostics/repair_validation.py framework/fuzzyxai/fuzzyxai/experiments/h10_c7.py framework/fuzzyxai/fuzzyxai/experiments/h10_c7_model_lock.py framework/fuzzyxai/fuzzyxai/experiments/h10_c7_replay.py scripts/ch4_revision/prepare_h10_c7_development.py scripts/ch4_revision/run_h10_c7_development.py scripts/ch4_revision/lock_h10_c7_model_weights.py scripts/ch4_revision/build_h10_c7_open_replay_bundle.py scripts/ch4_revision/run_h10_c7_open_replay.py tests/h10_c7
